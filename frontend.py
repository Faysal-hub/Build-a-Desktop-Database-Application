...
b1=tkinter.Button(mainwindow,text="View all", width=12,
background="blue", fg='white')
b1.grid(row=2,column=3)

b2=tkinter.Button(mainwindow,text="Search entry", width=12,
background="blue", fg='white')
b2.grid(row=3,column=3)

b3=tkinter.Button(mainwindow,text="Add entry", width=12,
background="blue", fg='white')
b3.grid(row=4,column=3)

b4=tkinter.Button(mainwindow,text="Update selected", width=12,
background="blue", fg='white')
b4.grid(row=5,column=3)

b5=tkinter.Button(mainwindow,text="Delete selected", width=12,
background="blue", fg='white')
b5.grid(row=6,column=3)

b6=tkinter.Button(mainwindow,text="Close", width=12,
background="blue", fg='white', command=window.destroy)
